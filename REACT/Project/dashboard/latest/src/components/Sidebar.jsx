      ...
      <div>
        <div className="mb-8 px-2">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[#818CF8] text-xl font-bold tracking-tight">Jobzenix</h1>
          </div>
          <p className="text-[10px] tracking-widest font-semibold mt-1 uppercase text-slate-500">Find Jobs in India</p>
        </div>
        ...
        <nav className="space-y-1">
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors font-medium text-left ${currentView === 'applied-jobs' ? 'bg-[#1E1B4B]/50 text-[#818CF8] relative' : 'hover:bg-white/5'}`}
          >
            {currentView === 'applied-jobs' && <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-[#818CF8] rounded-r-md"></div>}
            <Briefcase size={20} />
            Applied Jobs
          </button>
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors font-medium text-left mt-2 ${currentView === 'search-history' ? 'bg-[#1E1B4B]/50 text-[#818CF8] relative' : 'hover:bg-white/5'} border-t border-[#1F2937]/50 pt-4`}
          >
            {currentView === 'search-history' && <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-[#818CF8] rounded-r-md"></div>}
            <BarChart2 size={20} />
            Analytics
          </button>
        </nav>
