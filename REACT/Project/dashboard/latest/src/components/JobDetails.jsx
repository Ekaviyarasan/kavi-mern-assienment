...
const JobDetails = () => {
  return (
    <div className="flex-1 overflow-y-auto px-10 py-8 text-white relative bg-[#0B0F19]">
      
      {/* Breadcrumbs */}
      <div className="flex items-center gap-2 text-sm text-slate-400 font-medium tracking-wide mb-6">
        ...
        <div className="space-y-6">
           ...
           <div className="mb-4">
              <div className="flex gap-2 mb-4">
                 ...
                 <span className="bg-[#2A3143] font-bold tracking-widest uppercase text-[10px] px-3 py-1.5 rounded-full text-slate-300">
                   Delivery
                 </span>
              </div>
              ...
              <div className="flex items-center gap-6 text-slate-400 font-medium text-sm">
                 ...
                 <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-[#818CF8]/10 flex items-center justify-center">
                       <Clock size={14} className="text-[#818CF8]" fill="currentColor" />
                    </div>
                    Starts 2h from now
                 </div>
              </div>
