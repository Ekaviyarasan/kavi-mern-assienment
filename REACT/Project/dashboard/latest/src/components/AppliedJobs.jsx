      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-extrabold tracking-tight mb-2">
            Your <span className="text-[#818CF8]">Applied Jobs</span>
          </h1>
        ...
        {appliedJobs.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-slate-500 mt-2">Start browsing jobs across Tamil Nadu and Kerala in the marketplace!</p>
          </div>
        ) : (
